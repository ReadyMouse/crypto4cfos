...
> *Yes I put an asterisk on this. Hold that thought. We'll review a case study of the 51% attack on Monero later in course.
...
- **Public Blockchains** is using the roadways, parks, and bridges built by the community. It's publicly accessible, although sometimes with a fee. (Just like a useage fee at a National Park.) There is no need to maintain infrastructure
