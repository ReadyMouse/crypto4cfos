...
Recall, the skimming half-penny scheme from real life and the movie "Office Space". This requires half-pennies...which doesn't exist in our physical world. It's a function of digital calculation, floating decimal points. Ethereum uses an **Account-based model** for its ledger. Simply: It allows decimal point mathematics. 
...
Account Model: Ethereum, Solana, Tron, ...
