...
> **Note** An anti-state anarchist might point out that "Consensus" and "Collusion" are two-sides to the same coin. ;)
...
> **Note** A savy person might note that "smart contract" is a fancy word for "computer program".
